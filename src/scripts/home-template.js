	...
	<div id="skills" class="skills">
		...
		<div class= "skills-container">
			<div class= "front-end-skills my-skills">
				...
				<p> I wrote code using HTML5, CSS3 (SCSS), and JavaScript. For recent projects, I enjoy using React, jQuery, and Backbone.</p>
			</div>
	...
	<div id="contact" class="contact">
		<div class="jumbotron circle-jumbo">
			...
			<div class="my-contact">
				...
				<h2> shannonmcnellis@gmail.com </h2>
			</div>
		</div>
	...
	<div id="about" class="about-me">
		...
		<h1> About </h1>
			<div class= "about">
				...
				<p>Hi, I'm Shannon.  I am a recent graduate of The Iron Yard of Charleston, where my love for problem-solving and creating took shape in the form of coding for the first time.  I am a former Special Education teacher and will forever be inspired by individuality.</p>
			</div>
			<div class= "footer-container">
				<a class= "icon" href="https://github.com/smcnell"><i class="fa fa-github" aria-hidden="true"></i> <p>View @smcnell on GitHub for my current projects and explorations.</p></a>
				<a class= "icon" href="https://www.linkedin.com/in/shannon-mcnellis-291815138/"><i class="fa fa-linkedin-square" aria-hidden="true"></i> <p>Connect with me using LinkedIn</p></a>
				<a class= "icon" href="https://twitter.com/shannonmcnellis"><i class="fa fa-twitter-square" aria-hidden="true"></i><p>Follow Me on Twitter</p></a>
			</div>
		</div>
	</div>
